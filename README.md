...
![screenshot4](https://github.com/zw9seq/zw9seq/blob/b8beb9ec1e7509f97459a4b8057baf2cbf372801/misc/Nov09%3A%3A131841.png)
...
2. **Configure the variables**
   ...
   network_mode: "host"
   environment:
      - SNIFFER_IFACE=[INTERFACE]           # MODIFY THIS (e.g. SNIFFER_IFACE=eth0)
      - TZ=[TIMEZONE]                       # MODIFY THIS (e.g. TZ=Europe/Paris)
   volumes:
      - ./data:/app/data
   ```
